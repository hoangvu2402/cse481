...
<body style="padding: 80px;">
    <div class="wrap">
        <div class="header">
            <h2 class="header_title">ĐĂNG KÝ</h2>
        </div>

        <div class="main main_register">
            <form action="process_register.php" method ="POST" class="form_register">
                ...
                <div class="register">
                <button type="submit" class="register_button login" style="color: #5b69f3db; padding: 5px 12px" onclick="return add()"><h3>ĐĂNG KÝ</h3></button>
            </div>              
            </form>
